...
export function StudioShell() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] text-[#202124] transition-colors dark:bg-[#08090a] dark:text-[#f7f8f8] lg:grid lg:grid-cols-[220px_minmax(0,1fr)_320px] lg:grid-rows-[72px_minmax(0,1fr)]">
      ...
      </> : section === "poem" ? poemProject ? <PoemWriter key={poemProject.id} database={database} projectId={poemProject.id} projectName={poemProject.name} /> : <PoemProjectRequired onCreate={() => setCreateOpen(true)} /> : <GuidelineManager database={database} />}
